...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="/UserHome/{{$collection->id}}">MovieList</a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="Navbar">
                <ul class="navbar-nav">
                    <li class="nav-item p-1">
                        <a class="nav-link" href="/UserHome/{{$collection->id}}">Home</a>
                    </li>
                    <li class="nav-item p-1">
                        <a class="nav-link" href="/UserActors">Actors</a>
                    </li>
                    <li class="nav-item p-1">
                        <a class="nav-link" href="/UserWatchlist/{{$collection->id}}">My Watchlist</a>
                    </li>
                    <li class="nav-item dropdown p-1">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="/UserProfile/{{$collection->id}}">Profile</a></li>
